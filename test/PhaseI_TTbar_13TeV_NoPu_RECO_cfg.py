...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PhaseI_TTbar_13TeV_NoPu_RECO_newGT.root'),
...
process.RECOSIMoutput.outputCommands += cms.untracked.vstring('keep *_siPixelRecHits_*_*')
