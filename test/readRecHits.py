...
#process.GlobalTag.globaltag = '106X_upgrade2018_realistic_v11_L1v1' # for 272
process.GlobalTag.globaltag = '106X_upgrade2018_realistic_v16_L1v1' # for 272
...
# "/store/express/Run2016B/ExpressPhysics/FEVT/Express-v2/000/274/314/00000/1A57B62A-4328-E611-9D78-02163E01339F.root",
  #"file:/eos/cms/store/group/phys_heavyions/rchudasa/e2e/eventGenerationChecks/QCD_Pt-30to50_EMEnriched_digiToReco_withPileup_908.rooot"#QCDEmEnriched
  #"file:PhaseI_TTbar_13TeV_NoPu_RECO.root"#QCDEmEnriched
  "file:PhaseI_TTbar_13TeV_NoPu_RECO_newGT.root"#QCDEmEnriched
   )
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('histos_rechits_ttbar_newGT_xyz.root')
)
